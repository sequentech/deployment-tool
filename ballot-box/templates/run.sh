...
PID_FILE=/home/ballotbox/ballot-box/target/universal/stage/RUNNING_PID
if [ -f "$PID_FILE" ]
then
    kill -9 $(cat "$PID_FILE")
    rm "$PID_FILE"
...
/home/ballotbox/ballot-box/target/universal/stage/bin/ballot-box \
    -v \
    -Dconfig.file=/home/ballotbox/ballot-box/conf/application.conf \
    -Dlogger.file=/home/ballotbox/ballot-box/conf/logback.xml
